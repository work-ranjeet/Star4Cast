...
{
    public static class ProfileDataSeeding
    {
        public static void EnsureSocialAddressDataInserted(this ProfileDbContext context)
        {
        ...
        public static void EnsureCategoryInserted(this ProfileDbContext context)
        {
        ...
        public static void EnsureLanguageAndAscentInserted(this ProfileDbContext context)
        {
